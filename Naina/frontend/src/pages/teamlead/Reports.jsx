  ...
  const fetchReports = async () => {
    try {
      setTimeout(() => {
        setReports([
          { 
            id: 1, internName: 'Alice Johnson', title: 'Week 4 Progress Report', submittedDate: '2024-01-14', status: 'pending', file: 'report1.pdf' 
          },
          { 
            id: 2, internName: 'Mike Chen', title: 'Project Milestone 2', submittedDate: '2024-01-13', status: 'approved', file: 'report2.pdf' 
          },
          { 
            id: 3, internName: 'Sarah Lee', title: 'Week 3 Report', submittedDate: '2024-01-12', status: 'rejected', file: 'report3.pdf' 
          }
        ]);
        setLoading(false);
      }, 1000);
